...
public class Novels extends JFrame
{
    ...
    Novels(String usrname)
    {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/images/nov.png"));
        ...
        btn2.addActionListener(new ActionListener()
        {
            ...
            {
                setVisible(false);
                Novels2 frame = new Novels2(usrname);
        ...
        sb1 = new JRadioButton("500 tk");
        sb1.setBounds(110, 350, 120, 40);
        sb1.setFont(f2);
        sb1.setCursor(cursor);
        sb1.setBackground(Color.decode("#F2F2F2"));
        c.add(sb1);

        sb2 = new JRadioButton("620 tk");
        sb2.setBounds(390, 350, 120, 40);
        sb2.setFont(f2);
        sb2.setCursor(cursor);
        sb2.setBackground(Color.decode("#F2F2F2"));
        c.add(sb2);

        sb3 = new JRadioButton("450 tk");
        sb3.setBounds(670, 350, 120, 40);
        sb3.setFont(f2);
