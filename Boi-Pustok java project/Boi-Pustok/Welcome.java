...
public class Welcome extends JFrame
{
	...
	Welcome()
	{
		...
		// Logo and Images
        logo = new ImageIcon(getClass().getResource("/images/bb.png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(70, 35, logo.getIconWidth(), logo.getIconHeight());
        c.add(imgLabel);
		
		welcome = new ImageIcon(getClass().getResource("/images/Boi.png"));
