...
public class Detective extends JFrame
{
    ...
    Detective(String usrname)
    {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/images/dec.png"));
        ...
        btn2.addActionListener(new ActionListener()
        {
            ...
            {
                setVisible(false);
                Detective2 frame = new Detective2(usrname);
                frame.setVisible(true);
            }
        });
